_base_ = ['../lsknet/lsk_s_ema_fpn_1x_dota_le90.py', '../_base_/swa.py']
...
data = dict(
    ...
    train=dict(
        type='ConcatDataset',
        datasets=[dataset_train, dataset_train_aug, dataset_eval, dataset_eval_aug]
    ),
    val=dict(
        type=dataset_type,
        ann_file=data_root + '/eval/annotations',
...
swa_load_from = '/mnt/cfs_bj/nihao/data/ICJAI2023/output/lsk_s_ema_fpn_1x_dota_le90_hrfpn_bfp_ewa/latest.pth'
