...
test_pipeline = [
    ...
    dict(
        ...
        # img_scale=[(4096, 800), (4096, 1024)], # 0.828
        img_scale=(4096, 800),
        flip=False,
        transforms=[
            dict(type='RResize'),
...
data = dict(
    ...
    test=dict(
        ...
        # ann_file="/mnt/cfs_bj/nihao/data/ICJAI2023/test1_phase1/images/",
        # img_prefix="/mnt/cfs_bj/nihao/data/ICJAI2023/test1_phase1/images/",
        # ann_file="/mnt/cfs_bj/nihao/data/ICJAI2023/test2_phase1/images/",
        # img_prefix="/mnt/cfs_bj/nihao/data/ICJAI2023/test2_phase1/images/",
        # ann_file="/mnt/cfs_bj/nihao/data/ICJAI2023/test_phase2/images/",
        # img_prefix="/mnt/cfs_bj/nihao/data/ICJAI2023/test_phase2/images/",
        pipeline=test_pipeline))
