...
test_pipeline = [
    ...
    dict(
        ...
        # img_scale=[(1024, 1024), (1580, 1580)],
        img_scale=[(1024, 1024)],
        flip=True,
        transforms=[
            dict(type='RResize'),
            dict(type='RRandomFlip', flip_ratio=1., direction='diagonal', version=angle_version),
            dict(type='Normalize', **img_norm_cfg),
            dict(type='Pad', size_divisor=32),
...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + '/debug/annotations',
        img_prefix=data_root + '/debug/images/',
